...
<main>
  <section class="line_up_outer" >
    <section class="line-up">
      ...
      <div class="session_field_outer ronde_onthaal">
        <div class="label">
      ...
      <div class="session_field_outer ronde_1">
        <div class="label">
      ...
      <div class="session_field_outer ronde_2">
        <div class="label">
          <div class="label_indicator"></div>
          <p>Ronde 2</p>
        </div>
      ...
      <div class="session_field_outer ronde_middag">
        <div class="label">
      ...
      <div class="session_field_outer ronde_3">
        <div class="label">
          <div class="label_indicator"></div>
          <p>Ronde 3</p>
        </div>
      ...
      <div class="session_field_outer ronde_plenair">
        <div class="label">
          <div class="label_indicator correct"></div>
          <p>Plenair</p>
        </div>
      ...
      </div>  <div class="session_field_outer ronde_receptie">
          <div class="label">
            <div class="label_indicator correct"></div>
            <p>Receptie</p>
          </div>
